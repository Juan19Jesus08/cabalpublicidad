	 ...
	 echo '               <div class="courses-info">	<h1>'.$item->nombre.'</h1>
                    	 ...
                    	 <ul id="tab_list" class="nav nav-tabs">
										...
										<li class="active"><a href="#description" data-toggle="tab">Descripcion del Curso</a> </li>
																				...
																				<li  class=""><a href="#stucture" data-toggle="tab">Contenido del Curso</a> </li>
...
<?php	
    ...
    $clases=DB::select("select clases.nombre,clases.duracion from clases inner join cursos on cursos.id_curso=clases.id_curso where cursos.id_curso=$id_curso ");
							...
							<ul>
											...
											<ul>
																...
																<span class="tree-page-right">
																																			...
																																			<span fa fa-clock-o> '.$item->duracion.'</span>
...
?>
                    <!--fin del bloque de php clases del curso-->
...
$valor= $_GET['clase_de'];
$curso=  DB::select("SELECT * FROM cursos where cursos.nombre='$valor' ");
