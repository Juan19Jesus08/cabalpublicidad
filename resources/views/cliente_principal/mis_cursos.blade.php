...
<div class="page-spacer clearfix">
	<div id="primary" class="content-area">
       <div class="container">
		...
		<main id="main" class="site-main col-xs-12 col-sm-9 four-column"  >
                 ...
                 echo '<div class="course clist">';
                             ...
                             echo '</figure></div>';                                       
                                                     echo '<div class="course_space">';
                                                      echo '<div class="price"> ';                                        echo '<span></span></div>';
                                                     echo '<h3><a href="/mis_clases?clase_de='.$item->nombre.'">'.$item->nombre.'</a></h3>';
                                 echo '<p class="meta">';
