...
&nbsp;
<p style="text-align: center;"><span style="font-size: 24pt;">   <span style="font-size: 18pt;"> <strong> {{$nombre_usuario}}</strong></span></span></p>
&nbsp;
...
<span style="font-size: 18pt;">                                                   {{$nombre_curso}}</span>
<p style="text-align: left;"><span style="font-family: 'times new roman', times, serif;">                                                                   <span style="font-size: 14pt;"> <strong>Finalizado el</strong></span></span><span style="font-size: 14pt;"><strong> {{$fecha}} </strong></span></p>
&nbsp;
