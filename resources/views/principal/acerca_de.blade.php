...
<script type='text/javascript'>
/* <![CDATA[ */
var front_vars = {"withdraw_alert":"Please confirm that you want to withdraw from the course. If you withdraw, you will no longer be able to see your records for this course.","units_archive_url":"http:\/\/www.demos.themecycle.com\/educationpress\/about-us\/units\/"};
/* ]]> */
</script>
<script type='text/javascript'>
/* <![CDATA[ */
...
color:#262c38;
		...
		<style type="text/css" media="all" id="siteorigin-panels-grids-wp_head">/* Layout 58 */ #pgc-58-0-0 , #pgc-58-0-1 { width:50% } #pg-58-0 , #pg-58-1 , #pl-58 .panel-grid-cell .so-panel { margin-bottom:30px } #pg-58-0 .panel-grid-cell { float:left } #pg-58-1 .panel-grid-cell , #pg-58-2 .panel-grid-cell { float:none } #pl-58 .panel-grid-cell .so-panel:last-child { margin-bottom:0px } #pg-58-0 , #pg-58-1 , #pg-58-2 { margin-left:-15px;margin-right:-15px } #pg-58-0 .panel-grid-cell , #pg-58-1 .panel-grid-cell , #pg-58-2 .panel-grid-cell { padding-left:15px;padding-right:15px } @media (max-width:780px){ #pg-58-0 .panel-grid-cell , #pg-58-1 .panel-grid-cell , #pg-58-2 .panel-grid-cell { float:none;width:auto } #pgc-58-0-0 { margin-bottom:30px } #pl-58 .panel-grid , #pl-58 .panel-grid-cell {  } #pl-58 .panel-grid .panel-grid-cell-empty { display:none } #pl-58 .panel-grid .panel-grid-cell-mobile-last { margin-bottom:0px }  } </style><style type="text/css" title="dynamic-css" class="options-output">h1, h2, h3, h4, h5, h6, .h1, .h2, .h3, .h4, .h5, .h6{color:#262c38;}body{color:#657184;}blockquote,blockquote p{color:#657184;}a,p a{color:#263238;}a:hover,p a:hover{color:#ff5722;}a:active,p a:active{color:#263238;}.course .meta a, .course a, h2 a, h4 a, a.more, .entry-meta a, #secondary .widget a{color:#263238;}.course .meta a:hover, .course a:hover, h2 a:hover, h4 a:hover, a.more:hover, .entry-meta a:hover, #secondary .widget a:hover{color:#ff5722;}.course .meta a:active, .course a:active, h2 a:active, h4 a:active, a.more:active, .entry-meta a:active, #secondary .widget a:active{color:#263238;}.btn-orange, a.btn-orange, .btn-orange:active, .btn-orange:focus,
...
<body class="page page-id-58 page-template page-template-page-templates page-template-tpl-pagebuilder page-template-page-templates/tpl-pagebuilder-php page-about-us siteorigin-panels">
...
})();</script><link rel='stylesheet' id='siteorigin-widget-icon-font-fontawesome-css'  href='http://www.demos.themecycle.com/educationpress/wp-content/plugins/so-widgets-bundle/icons/fontawesome/style.css?ver=4.6.14' type='text/css' media='all' />
<script type='text/javascript' src='http://www.demos.themecycle.com/educationpress/wp-content/plugins/contact-form-7/includes/js/jquery.form.min.js?ver=3.51.0-2014.06.20'></script>
<script type='text/javascript'>
/* <![CDATA[ */
