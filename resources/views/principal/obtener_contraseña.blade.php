...
<link rel='stylesheet' href='/css/load-styles' type='text/css' media='all' />
<link rel='stylesheet' id='educationpress-bootstrap-checkbox-css'  href='/css/build.css' type='text/css' media='all' />
<link rel='stylesheet' id='educationpress-custom-forgot-css'  href='/css/forgot-password' type='text/css' media='all' />
<style id='educationpress-custom-forgot-inline-css' type='text/css'>
    ...
    {!! Form::submit( 'Nueva Contraseña', ['class' => 'btn btn-info btn-block', 'name' => 'submitbutton', 'value' => 'login'])!!}
    {{ Form::close() }}
...
<a href="/iniciar_sesion">Iniciar sesion</a>
 | <a href="/registrar">Registrarse</a></p>
	...
	<p id="backtoblog"><a href="/index">&larr; Cabal Publicidad</a></p>
